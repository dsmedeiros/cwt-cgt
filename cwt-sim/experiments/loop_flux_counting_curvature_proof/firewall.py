...
ROLE_MODULES = {
    "geometry": "experiments.loop_flux_counting_curvature_proof.geometry_lane",
    "counting": "experiments.loop_flux_counting_curvature_proof.counting_lane",
    "oracle": "experiments.loop_flux_counting_curvature_proof.oracle_lane",
}
ALLOWED_IMPORT_MODULES = {
    "geometry": {
        ...
        "fractions",
        "functools",
        "experiments.loop_flux_counting_curvature_proof.exact",
        "experiments.loop_flux_counting_curvature_proof.contract",
        "experiments.loop_flux_counting_curvature_proof.generator",
    },
    "counting": {
        "__future__",
        "fractions",
    ...
    "oracle": {
        ...
        "experiments.loop_flux_counting_curvature_proof.exact",
        "experiments.loop_flux_counting_curvature_proof.generator",
        "experiments.loop_flux_counting_curvature_proof.pipeline",
    },
}
REFLECTION_CALLS = {
    "__import__",
...
def authenticated_role_sources() -> dict[str, dict[str, object]]:
    ...
    for role, relative in ROLE_PATHS.items():
        ...
        records[role] = {
            "path": f"experiments/loop_flux_counting_curvature_proof/{relative}",
