"""Standalone CLI for the one-chord loop-flux proof."""
...
if __package__ in (None, ""):
    ...
    from experiments.loop_flux_counting_curvature_proof.artifacts import (  # type: ignore[import-not-found]
    ...
    from experiments.loop_flux_counting_curvature_proof.theorem import (  # type: ignore[import-not-found]
        execute_program,
    )
else:
...
@app.command()
def run() -> None:
    """Execute gates and transactionally publish one complete generation."""
...
@app.command()
def verify() -> None:
    """Verify semantic status and the complete five-file closure."""
