...
def test_rectangle_tau_zeta_phase_area_matches_orientation() -> None:
    center = {"tau": 0.8, "zeta_phase": 0.0}
    extents = {"tau": 0.02, "zeta_phase": 0.02}
    ...
    _loop_closure(path_ccw, "tau", "zeta_phase")
    expected_area = 4.0 * extents["tau"] * extents["zeta_phase"]
    ...
    _loop_closure(path_cw, "tau", "zeta_phase")
